...
- Supported delivery of [product or initiative] while working across [engineering, product, design, operations, etc.].
...
- **Link:** [GitHub or Demo URL](https://github.com/your-username/project-name)
